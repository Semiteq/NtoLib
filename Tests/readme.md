...
- Значения в ячейках форматируются согласно конфигурации, становятся целыми, где ожидается целое, принимают
  экспоненциальную форму и пр.
...
- Несовпадение состава ActionDefs.yaml с составом action
...
- При переходе на экран рецепта, когда выполняется рецепт, рецепт должен корректно загрузиться и отобразить текущий
  прогресс.
