...
public struct Bounds
{
	...
	public PointF LeftTop => new(Left, Top);

	/// <summary>Левый нижний угол</summary>
	public PointF LeftBottom => new(Left, Bottom);

	/// <summary>Правый верхний угол</summary>
	public PointF RightTop => new(Right, Top);

	/// <summary>Правый нижний угол</summary>
	public PointF RightBottom => new(Right, Bottom);

	/// <summary>Середина левой границы</summary>
	public PointF LeftCenter => new(Left, CenterY);

	/// <summary>Середина верхней границы</summary>
	public PointF CenterTop => new(CenterX, Top);

	/// <summary>Середина правой границы</summary>
	public PointF RightCenter => new(Right, CenterY);

	/// <summary>Середина нижней границы</summary>
	public PointF CenterBottom => new(CenterX, Bottom);
	...
	public static Bounds FromRectangle(RectangleF rectangle, PointF pivot)
	{
		...
		{
			Pivot = pivot,
			X = rectangle.X + rectangle.Width * pivot.X,
			Y = rectangle.Y + rectangle.Height * pivot.Y,
