...
ConfigLoader позволяет централизованно хранить и управлять именами оборудования (заслонок, источников, нагревателей, водяных каналов) в единственном конфигурационном файле. Блок обеспечивает:
