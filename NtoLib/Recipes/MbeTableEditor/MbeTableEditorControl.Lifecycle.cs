...
public partial class MbeTableEditorControl
{
	...
	private void InitializeServicesAndRuntime()
	{
		...
		if (FBConnector.Fb is not MbeTableEditorFB editorFb)
		{
			return;
		}

		_serviceProvider = editorFb.ServiceProvider;
	...
	private void InitializeLogger()
	{
		...
		_logger.LogDebug("Starting MbeTableEditorControl initialization");
	}
	...
	private void MarkInitialized()
	{
		...
		_logger!.LogDebug("MbeTableEditorControl initialization completed");
	}
