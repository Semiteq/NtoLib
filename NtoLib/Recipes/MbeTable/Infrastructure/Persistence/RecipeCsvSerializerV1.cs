...
public sealed class RecipeCsvSerializerV1 : IRecipeSerializer
{
    ...
    private readonly ActionsFingerprintUtil _actionsFingerprintUtil;
    private readonly CsvHeaderBinder _csvHeaderBinder;
    private readonly CsvStepMapper _csvStepMapper;
