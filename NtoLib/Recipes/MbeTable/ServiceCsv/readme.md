...
1. Блок метаданных (строки, начинаются с `#`, заключаются в кавычки, читаться могут без кавычек для обратной совместимости, но не гарантируется правильная проверка)
