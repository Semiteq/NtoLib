...
namespace NtoLib.Recipes.MbeTable.RecipeLines.RecipeTime
{
        ...
        public interface IRecipeTimeManager
        {
            ...
            ICountTimer? ManageRecipeTimer(bool isRecipeActive, ICountTimer? currentTimer, TimeSpan totalRecipeTime, ILoggerFactory loggerFactory);
            void UpdateRecipeTimeDisplay(float plcLineTime, ICountTimer? countdownTimer, Action<double> setTotalTime, Action<double> setLineTime, ILogger? logger);
        }
