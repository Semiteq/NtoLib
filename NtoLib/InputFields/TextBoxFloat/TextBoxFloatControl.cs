...
public partial class TextBoxFloatControl : VisualControlBase
{
	...
	protected override void OnPaint(PaintEventArgs e)
	{
		...
		if (!DesignMode)
		{
			...
			var input = FBConnector.GetPinValue<float>(TextBoxFloatFB.OutputToControlId);
			if (input != _lastInput)
			{
				_lastInput = input;
				_value = input;
	...
	{
		var actualIsLocked = _inputLock || UserLock;
	...
	{
		var format = "0." + new string('0', decimalPoints);
