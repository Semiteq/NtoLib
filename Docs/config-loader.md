...
> **Кратко:** Загружает и сохраняет имена оборудования (заслонки, источники, нагреватели, вода, газы) из YAML-файла. При переходе в режим исполнения читает файл и раздаёт имена по выходам. По команде Save собирает имена со входов, валидирует, записывает в файл и обновляет выходы. Если файла нет -- создаёт пустой автоматически.
...
### Динамические группы входов и выходов
...
Все входы и выходы групп имеют тип `string`.
