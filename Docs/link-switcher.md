...
| 102 | IsPending | Логический | `true` если задача в очереди, ожидает перехода в Design mode |
...
> **Внимание:** В интерфейсе MasterSCADA нет визуальной индикации хода или завершения отложенного исполнения. Чтобы убедиться, что операция завершена, отслеживайте лог-файл (`C:\DISTR\Logs\link-switcher.log`). Ищите строку `"Deferred execution completed successfully"` или сообщения об ошибках.
...
5. Для каждой операции из плана:
