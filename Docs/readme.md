...
| 6 | [NumericBox](numeric-box.md) | Поле ввода числового значения с арбитрацией и валидацией |
| 7 | [Installer](installer.md) | Графический установщик NtoLib: копирование файлов, конфигурации и COM-регистрация |
| 8 | [OpcTreeManager](opc-tree-manager.md) | Перестройка дерева OPC UA FB под выбранный целевой проект с произвольной глубиной вложенности (shrink/expand с восстановлением связей на любом уровне) |
