...
| 3 | [LinkSwitcher](link-switcher.md) | Переключение связей между структурно идентичными объектами |
| 4 | [MbeTable](mbe-table.md) | Таблица рецептов MBE: конфигурация, интерфейс оператора, Modbus TCP, CSV |
| 5 | [MbeTableEditor](mbe-table-editor.md) | Редактор рецептов MBE: вариант таблицы без обмена с ПЛК (только редактирование, CSV, буфер обмена) |
| 6 | [NumericBox](numeric-box.md) | Поле ввода числового значения с выбором более нового значения и проверкой диапазона |
| 7 | [Installer](installer.md) | Графический установщик NtoLib: копирование файлов, конфигурации и COM-регистрация |
| 8 | [OpcTreeManager](opc-tree-manager.md) | Перестройка дерева OPC UA FB под выбранный целевой проект с произвольной глубиной вложенности (сжатие и расширение с восстановлением связей на любом уровне) |
| 9 | [Pump](pump.md) | Управление и индикация вакуумного насоса (форвакуумный/турбо/ионный/криогенный), регенерация криогенного насоса |
| 10 | [Valve](valve.md) | Управление и индикация клапана (обычный, плавный, шибер, ручной, без датчиков положения) |
...
| [OpcUaNamespaceIndexNotIdentity](known_issues/12-opc-ua-namespace-index-not-identity.md) | Индекс namespace в сохранённом `NodeId` — позиция в таблице сервера, а не идентичность: смещение таблицы даёт отсутствие значений либо значения чужого интерфейса (механика адресации — в primer) |
